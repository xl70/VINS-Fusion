...
void PoseGraph::addKeyFrame(KeyFrame* cur_kf, bool flag_detect_loop)
{
	...
	if (loop_index != -1)
	{
	    ...
	    //如果回环帧与当前帧不在同一个图像序列，将他们合并到世界坐标系下----开始
            ...
            //如果回环帧与当前帧不在同一个图像序列，将他们合并到世界坐标系下----结束
    ...
    //获取vio当前位姿P、R，根据偏移量更新实际位姿----结束
    
    //构建path[squence_cnt]并发布----开始
    Quaterniond Q{R};
